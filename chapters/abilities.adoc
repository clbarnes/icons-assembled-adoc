...
When dealing with issues of will or using powers of the mind, this ability determines the outcome of the action.
It influences social interaction and making an impression on people.
