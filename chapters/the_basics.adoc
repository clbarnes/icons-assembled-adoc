...
Abilities are described in detail in their own section on p.
XXX.
...
Specialties and their uses are described in detail on p.
XXX.
...
Powers and their effects are described in detail on p.
XXX.
...
character.
Determination and how it works is described in detail on p.
XXX.
