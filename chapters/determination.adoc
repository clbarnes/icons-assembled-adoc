...
Heroes gain and lose Determination as the game
...
Players define these aspects when creating and
...
Some aspects
tend to come up in play more often than others.
However, since all
...
the appropriate time for a suitable action.
However, you (the player)
...
the various important people in the character's life.
While heroes are
...
have declared a connection in danger!
(See *Tagging and Compelling
...
help, if only in the form of motivation.
If a hero's connection is
solely a challenge, see the Challenges section.

==== Epithet

An epithet is a title or descriptive phrase applied to your character,
often used in dramatic dialog.
Examples include: Man of Tomorrow, Maiden
of Might, Master of the Mystic Arts, and World's Greatest [fill-in the
blank].
It typically describes something about the hero's style, powers,
...
epithet.
The GM should ensure that the character with the epithet really
does qualify for it!
The only case where more than one character can
have a singular epithet is when two or more are competing for it.
In
...
some other test of who's faster whenever they get together.
Plus there
...
(or, at least, we hope that they are).
The identity quality deals with a
...
a colorfully clad and world-famous hero might not.
A Wealthy
...
After all,
villains often go through the same origins.
What makes some choose
heroism over villainy?
In short, what motivates someone to become a
hero?

A motivation quality describes what made your character take the hero's
path, and what keeps him or her on it, even when things get tough.
It
...
makes the difference between giving up and pushing ahead.
The GM might
...
If you have an idea for a particularly good
quality for your character that does not fit into one of the previously
described categories, discuss it with your Game Master.
So long as it
...
describe things about your character.
Unlike qualities, which tend to
have both positive and negative sides, challenges are all about the
things your hero works to overcome.
While the GM can compel challenges,
...
and you may choose up to five to start with.
Unlike qualities, your hero
does not have to have any challenges.
The fewer the challenges, the less
hassle your hero faces, but the fewer opportunities you have to earn
Determination.
Plus challenges put the spotlight on your hero, if only
...
challenge is compelled, bad things happen.
Your hero's car might be
booted or repossessed, the rent might come due when there's no money to
pay it, a critical device might stop working...
pretty much any cruel
thing the GM can think of that does not outright remove your character
from the game.
Like other challenges, you can stave off Bad Luck with
...
an enemy with a specific vendetta against your hero.
The GM can compel
it to have your enemy show up or gain an advantage over you, such as
springing a trap or ambush.
Note that just having your enemy show up in
...
confined to a wheelchair to blindness.
Whatever the case, the GM can
compel your hero's personal challenge in any situation where it might be
a hindrance.
In the case of psychological challenges, it may temporarily
...
who looks like, say, a classical demon or a rocky monster.
It can make
...
night, or strange radioactive mineral.
...
defeat.
Compelling your weakness lets the GM inflict pretty much any
...
Sometimes
they’ll be fairly obvious.
When they’re not, you can make an appropriate
...
Determination for accepting the consequences of it.
For example, the GM
...
reacting too well to your strange appearance" or the like.
If you
...
ideas for five of each right away.
Good ideas for aspects often suggest
...
creation.
They do not have to define any challenges (as heroes aren't
required to have any).
At any time during play, a player can choose a
...
When making a determined effort, state the
desired outcome of the test (moderate, major, or massive success).
If
...
at least a major success.
You roll the dice and get an effect of 0, a
moderate success.
So you subtract 0 from 3 (the minimum for a major
success), getting 3 levels.
Spending 2 points of Determination, you push
...
is what you wanted.
So, in the previous example, if the effect had been
4 (enough for a major success), you'd still have to spend 1 point of
Determination for the determined effort.
Moreover, if you achieve the
...
want.
You still get the +2 levels from that point of Determination and
...
effort is relevant to your hero.
For example, an epithet can show how
...
So, for example, you can declare a
determined effort on your Coordination test to catch your falling
girlfriend, because you'll only get one chance.
You can't declare
...
off, the foe activates his doomsday device, or the like.
When in doubt,
...
or she is more effective, a focused effort.
You use the new trait for
...
Intellect test.
A focused effort can also be declared a determined
...
Determination to recover once during any given conflict.
After that, you
...
and story during the game.
"Retcon" is a comic book term for
...
or detail something previously unknown.
If the GM agrees, then it
becomes true.
For example, you can retcon the contents of a storeroom to
...
to the retcon (see *Tagging and Compelling*, previously).
Examples
...
Determination on a retcon.
The GM may also allow you to retcon with a
...
unless you come up with some plausible reason
why that information was never true to begin with!
The GM has final say
on retcons, but generally, if what you propose makes the game more
interesting, odds are in your favor.
If a proposed retcon isn't
...
to create a powerful shockwave.
They're somewhat like retcons, where
...
This is usually something like a catchphrase or
epithet, although other qualities (particularly motivation) can serve in
some instances.
Then you describe what you want to the stunt to
accomplish and the GM decides whether or not it suits your hero's
quality and traits.
The GM always has the option of disallowing
...
the difficulty.
If the test fails, so does the stunt, and nothing
happens.
With an effect of 0, the stunt works, but there are side
effects, determined by the GM.
You might whip up a whirlwind, but also
...
the hero's aspects by the Game Master.
...
your hero's aspects.
In fact, you can offer up opportunities as part of
playing your character's role, and earn Determination for doing it!
Game
...
to offer a suggestion or reminder.
For example, if you spot a perfect
chance to endanger one of your hero's connections during a massive
battle, just say so.
The GM may take your suggestion and award you a
point of Determination.
Good thing, as you're going to need it to take
...
for the GM to compel.
For example, to push your armored hero's
...
effort, your hero's power-suit is going to shut down!
Better make it
count...
...
with a minimum of 1), it increases up to that amount.
However, if it's
